...
export type ProductBySkuQueryVariables = StorefrontAPI.Exact<{
...
export type ProductBySkuQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
        'id' | 'title' | 'handle' | 'descriptionHtml' | 'tags' | 'productType'
      > & {
        featuredImage?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ProductBySku($query: String!) {\n    products(first: 1, query: $query) {\n      nodes {\n        id\n        title\n        handle\n        descriptionHtml\n        featuredImage { url altText width height }\n        tags\n        productType\n        variants(first: 1) {\n          nodes {\n            id\n            availableForSale\n            sku\n            price { amount currencyCode }\n            compareAtPrice { amount currencyCode }\n          }\n        }\n      }\n    }\n  }\n': {
    return: ProductBySkuQuery;
    variables: ProductBySkuQueryVariables;
  };
